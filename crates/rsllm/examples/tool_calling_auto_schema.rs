...
impl SchemaBasedTool for Calculator {
    ...
    fn execute_typed(
        ...
        tracing::debug!("   📥 Received strongly-typed params: {:?}", params);
...
impl SchemaBasedTool for WeatherTool {
    ...
    fn execute_typed(
        ...
        tracing::debug!("   📥 Weather request for: {:?}", params);
...
async fn main() -> Result<(), Box<dyn Error>> {
    tracing::debug!("✨ RSLLM Automatic Schema Generation Example");
    tracing::debug!("==============================================\n");

    // Step 1: Create registry and register tools
    tracing::debug!("📦 Step 1: Creating tool registry with auto-schema tools...");
    ...
    tracing::debug!("🔍 Step 2: Auto-generated JSON schemas:");
    ...
    tracing::debug!("🚀 Step 3: Executing tools with type-safe parameters\n");

    // Example 1: Calculator
    tracing::debug!("   Example 1: Calculator (add 42 + 58)");
    ...
    tracing::debug!("   Example 2: Weather (Tokyo with forecast)");
    ...
    tracing::debug!("   Example 3: Search (using default limit)");
    ...
    tracing::debug!("⚠️  Step 4: Automatic validation");
    tracing::debug!("   Attempting invalid operation (divide by zero)...");
    ...
    if !invalid_result.success {
        tracing::debug!("   ❌ Caught error: {}", invalid_result.error.unwrap());
    }

    tracing::debug!("🎉 Automatic Schema Generation Complete!\n");
    tracing::debug!("💡 Key Benefits:");
    tracing::debug!("   ✅ NO manual JSON schema writing");
    tracing::debug!("   ✅ Type-safe parameter handling");
    tracing::debug!("   ✅ Automatic validation");
    tracing::debug!("   ✅ Schema always in sync with types");
    tracing::debug!("   ✅ Serde integration for defaults");
    tracing::debug!("   ✅ Schemars attributes for descriptions");
